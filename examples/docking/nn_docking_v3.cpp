...
int main(int argc, char *argv[])
{
	...
	*/
	...
	plot_setting.plot_2D_octagon_GNUPLOT("./outputs/", nn_name + "_x1x2_Steps" + to_string(steps) + "_"  + to_string(if_symbo), result.tmv_flowpipes, setting);
	plot_setting.setOutputDims("x5", "x6");
	plot_setting.plot_2D_octagon_GNUPLOT("./outputs/", nn_name + "_x5x6_Steps" + to_string(steps) + "_"  + to_string(if_symbo), result.tmv_flowpipes, setting);
