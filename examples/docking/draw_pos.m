...
Duration = 180 * 1; % Simulation horizon
...
x2 = (0.2 + 2.0 * 0.001027 * sqrt(26 * 26 + 26 * 26)) * (-0.9); % * rand(1) * cosd(ang_radius * rand(1));
x3 = -(0.2 + 2.0 * 0.001027 * sqrt(26 * 26 + 26 * 26)) * (-0.9); % * rand(1) * sind(ang_radius * rand(1));
x4 = sqrt(x2 * x2 + x3 * x3);
