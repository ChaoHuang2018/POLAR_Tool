...
int main(int argc, char *argv[])
{
	...
	string benchmark_name = "reachnn_benchmark_5_" + net_name;
	...
	*/
	ODE<Real> dynamics({"x2^3-x1","x2","u","1","0"}, vars);
	...
	Interval init_x0(0.39 - w, 0.39 + w), init_x1(0.46 - w, 0.46 + w), init_x2(0.26 - w, 0.26 + w), init_t(0);
