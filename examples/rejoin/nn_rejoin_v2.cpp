...
void build_winman_frame_rot_mat(TaylorModelVec<Real> & winman_fram_rot_mat, const TaylorModel<Real> &state, const vector<Interval> & domain, const unsigned int order, const Interval & cutoff_threshold, const Global_Setting & setting) {
...
void normalize(TaylorModelVec<Real> & normalized_states, const TaylorModelVec<Real> & states, const TaylorModel<Real> & state, const vector<Interval> & domain, const unsigned int order, const Interval & cutoff_threshold, const Global_Setting & setting) {
...
void preprocess(TaylorModelVec<Real> & tmv_inputs, const TaylorModelVec<Real> & winman_fram_rot_mat, const TaylorModelVec<Real> &states, const vector<Interval> & domain, const unsigned int order, const Interval & cutoff_threshold, const Global_Setting & setting) {
...
int main(int argc, char *argv[])
{
	...
	//Expression<Real> deriv_x15("((x11 - x8) * x1 - x2 * (x2 * (x11 - x8) + x3 * (x12 - x9)) / x1) / (x1 * x1)", vars);
	//Expression<Real> deriv_x16("((x12 - x9) * x1 - x3 * (x2 * (x11 - x8) + x3 * (x12 - x9)) / x1) / (x1 * x1)", vars);
	//Expression<Real> deriv_x17("((x11 - x8 - 500 * sin(60 * pi/ 180 + pi + x14) * u1) * x4 - x5 * (x5 * (x11 - x8 - 500 * sin(60 * pi/ 180 + pi + x14) * u1) + x6 * (x12 - x9 + 500 * cos(60 * pi/ 180 + pi + x14) * u1)) / x4) / (x4 * x4)", vars); // deriv_x4 = x7
	//Expression<Real> deriv_x18("((x12 - x9 + 500 * cos(60 * pi/ 180 + pi + x14) * u1) * x4 - x6 * (x5 * (x11 - x8 - 500 * sin(60 * pi/ 180 + pi + x14) * u1) + x6 * (x12 - x9 + 500 * cos(60 * pi/ 180 + pi + x14) * u1)) / x4) / (x4 * x4)", vars); // deriv_x5 = x8
	//Expression<Real> deriv_x19("((u4 * cos(x13) - u3 * x7 * sin(x13)) * x7 - x8 * (x8 * (u4 * cos(x13) - u3 * x7 * sin(x13)) + x9 * (u4 * sin(x13) + u3 * x7 * cos(x13))) / x7) / (x7 * x7)", vars); // deriv_x7 = u3 * x7/x6 - u2 * x8
	//Expression<Real> deriv_x20("((u4 * sin(x13) + u3 * x7 * cos(x13)) * x7 - x9 * (x8 * (u4 * cos(x13) - u3 * x7 * sin(x13)) + x9 * (u4 * sin(x13) + u3 * x7 * cos(x13))) / x7) / (x7 * x7)", vars); // deriv_x8 = u3 * x8/x6 + u2 * x7
	//Expression<Real> deriv_x21("((u2 * cos(x14) - u1 * x9 * sin(x14)) * x10 - x11 * (x11 * (u2 * cos(x14) - u1 * x9 * sin(x14)) + x12 * (u2 * sin(x14) + u1 * x9 * cos(x14))) / x10) / (x10 * x10)", vars); // deriv_x10 = u1 * x11/x10 - u1 * x12
	//Expression<Real> deriv_x22("((u2 * sin(x14) + u1 * x9 * cos(x14)) * x10 - x12 * (x11 * (u2 * cos(x14) - u1 * x9 * sin(x14)) + x12 * (u2 * sin(x14) + u1 * x9 * cos(x14))) / x10) / (x10 * x10)", vars); // deriv_x11 = u1 * x12/x10 - u1 * x11	
	...
	Interval
		...
		//init_x15(init_x2 / init_x1);
		//init_x16(init_x3 / init_x1);
		//init_x17(init_x5 / init_x4);
		//init_x18(init_x6 / init_x4);
		//init_x19(init_x8 / init_x7);
		//init_x20(init_x9 / init_x7);
		//init_x21(init_x11 / init_x10);
		//init_x22(initx_12 / init_x10);
	...
	string nn_name = "./rl_tanh256x256_tail";
