...
function dxdt = tora(t,x)
    ...
    dxdt =[ (x(2) * (x(11) - x(8)) + x(3) * (x(12) - x(9))) / x(1);
            ...
            (x(11) * (control_input(2) * cosd(x(14)) - control_input(1) * sind(x(14))) + x(12) * (control_input(2) * sind(x(14)) + control_input(1) * cosd(x(14)))) / x(10);
            control_input(2) * cosd(x(14)) - control_input(1) * sind(x(14));
            control_input(2) * sind(x(14)) + control_input(1) * cosd(x(14));
