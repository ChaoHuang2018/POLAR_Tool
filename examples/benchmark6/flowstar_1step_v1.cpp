...
int main(int argc, char *argvs[])
{
	...
	*/
	 ...
	 */
	Interval init_x0(stod(argv[4]), stod(argv[5])), init_x1(stod(argv[6]), stod(argv[7])), init_x2(stod(argv[8]), stod(argv[9])), init_x3(stod(argv[10]), stod(argv[11])), init_u(stod(argv[12]), stod(argv[13])); // w=0.05
