...
int main(int argc, char *argv[])
{
	...
	int steps = 1;
	Interval init_x0(stod(argv[2]), stod(argv[3])), init_x1(stod(argv[4]), stod(argv[5])), init_t(0), init_u(stod(argv[6]), stod(argv[7])); // w=0.05
     ...
     */
    plot_setting.plot_2D_octagon_GNUPLOT("./outputs/", "step_"  + to_string(steps) + "_"  + to_string(if_symbo), result.tmv_flowpipes, setting);
