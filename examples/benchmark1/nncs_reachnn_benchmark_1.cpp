...
int main(int argc, char *argv[])
{
	...
	vector<string> derivatives = {"x1","u * x1^2 - x0","0","1"};

	// create the neural network object for the controller
	string net_name = argv[6];
	string benchmark_name = "nncs_reachnn_benchmark_1_" + net_name;
	...
	Interval init_x0(0.85-w, 0.85+w), init_x1(0.55-w, 0.55+w);
