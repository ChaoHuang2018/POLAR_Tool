...
int main(int argc, char *argv[])
{
	...
	int x12_id = vars.declareVar("x12");	// hd_w
	int x13_id = vars.declareVar("x13");	// hd_l

	// normalization
	int x14_id = vars.declareVar("x14");	// rel_dist / 1000
	int x15_id = vars.declareVar("x15");	// rej_dist / 1000
	int x16_id = vars.declareVar("x16");	// wvel / 400
	int x17_id = vars.declareVar("x17");	// lvel / 400
