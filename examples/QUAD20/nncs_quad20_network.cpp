...
int main(int argc, char *argv[])
{
	...
	string net_name = argv[7];
	string comb = argv[6]; //neuron_approx_type in PolarSetting
	string benchmark_name = "nncs_quad_w" + to_string(int(stod(argv[1]) * 1000)) + "_order" + to_string(stoi(argv[4])) + "_" + comb + "_" + net_name;
	string nn_name = "quad_controller_" + net_name;
