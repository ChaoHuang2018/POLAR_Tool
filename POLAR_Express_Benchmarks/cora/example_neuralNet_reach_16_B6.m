function completed = example_neuralNet_reach_16_B6
% example_neuralNet_reach_16_Benchmark 6 - example of reachability analysis for a
%                                   neural network controlled numerical
%                                   benchmark 6 in POLAR
%
%
% Syntax:
%    completed = example_neuralNet_reach_16_B6()
%
% Inputs:
%    no
%
...
disp("BENCHMARK6 from POLAR")
disp("Here")

% Parameter ---------------------------------------------------------------
% initial set
R0 = interval([-0.77;-0.45;0.51;-0.3],[-0.75;-0.43;0.53;-0.28]);
% time horizon
params.tFinal = 5.0;
...
nn = NeuralNetwork.readONNXNetwork('nn_6_relu_tanh.onnx');
...
safeSet = interval([-5;-5;-5;-5],[5;5;5;5]);
...
xlim([-1, 1]);
ylim([-1, 1]);
rectangle('Position',[-0.1 -0.9 0.3 0.3])
