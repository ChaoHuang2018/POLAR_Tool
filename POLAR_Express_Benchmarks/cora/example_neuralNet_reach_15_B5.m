function completed = example_neuralNet_reach_15_B5
% example_neuralNet_reach_15_Benchmark 5 - example of reachability analysis for a
%                                   neural network controlled numerical
%                                   benchmark 5 in POLAR
%
%
% Syntax:
%    completed = example_neuralNet_reach_15_B5()
%
% Inputs:
%    no
%
...
disp("BENCHMARK5 from POLAR")
disp("Here")

% Parameter ---------------------------------------------------------------
% initial set
R0 = interval([0.38;0.45;0.25],[0.4;0.47;0.27]);
% time horizon
params.tFinal = 2.0;
...
nn = NeuralNetwork.readONNXNetwork('nn_5_sigmoid.onnx');
...
xlim([-0.5, 0.5]);
ylim([-0.3, 0.6]);
rectangle('Position',[-0.43 0.05 0.28 0.17])
