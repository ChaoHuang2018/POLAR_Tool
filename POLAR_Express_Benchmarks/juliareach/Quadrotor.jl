...
X₀ = Hyperrectangle([-0.4, -0.4, -0.4, -0.4, -0.4, -0.4, 0, 0, 0, 0, 0, 0],
...
alg = TMJets(abstol=1e-12, orderT=6, orderQ=1, adaptive=false);
...
print(io, "JuliaReach, Quadrotor, small X0, verified, $(res.time)\n")
