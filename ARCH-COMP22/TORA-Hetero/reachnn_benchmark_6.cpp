...
*/
	...
	plot_setting.plot_2D_octagon_GNUPLOT("./outputs/", "Tora_hetero_x0_x1", result.tmv_flowpipes, setting);


	plot_setting.setOutputDims("x2", "x3");
	plot_setting.plot_2D_octagon_GNUPLOT("./outputs/", "Tora_hetero_x2_x3", result.tmv_flowpipes, setting);
